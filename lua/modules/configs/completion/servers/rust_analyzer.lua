-- https://kgithub.com/neovim/nvim-lspconfig/tree/master/lua/lspconfig/server_configurations/rust_analyzer.lua
...
return {
	...
	docs = {
		description = [[
https://kgithub.com/rust-lang/rust-analyzer
rust-analyzer (aka rls 2.0), a language server for Rust
See [docs](https://kgithub.com/rust-lang/rust-analyzer/blob/master/docs/user/generated_config.adoc) for extra settings.
